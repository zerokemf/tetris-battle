...
(async () => {
    ...
    try {
        ...
        section('Real clear feedback across P2P');
        assert(await host.evaljs(`document.getElementById('input-settings-button').disabled && !InputManager.openSettings()`), 'live online handling settings cannot pause the match');
