...
Frontend: GitHub Pages. Backend: NAS Apache/PHP at `/tetris-leaderboard/api.php`.
...
- NAS runtime: `/share/Web/tetris-leaderboard/api.php`; private JSON under `private/scores.json`. `private/.htaccess` denies HTTP access (must verify403 on deployment). No leaderboard data in GitHub or Pages artifacts.
